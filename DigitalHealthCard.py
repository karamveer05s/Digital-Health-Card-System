...
def create_database_and_table():
    operation = """CREATE DATABASE IF NOT EXISTS digital"""
    cursor.execute(operation)

    operation = """USE digital"""
    cursor.execute(operation)
...
choose_img=Image.open(r"C:\project\user_login_temp_img.png")
 ...
 #-----------------------------------------------------Updating Data-------------------------------------------------------------           
            ...
            def more_data():
                ...
                def update_more_data():
                    ...
                    messagebox.showinfo("digital health card system","Successfully More Data Update record.")
...
def check():
    ...
    #elif(getusername.get()=='1' and getpassword.get()=='1'):
    ...
    try:    
        if getpassword.get() == doctor_password and getusername.get() == d_username:
            try:
                ...
                messagebox.showerror("Digital health card system","wrong username and password")
...
def home():
    ...
    global ph
    img=Image.open(r"C:\project\home photo.jpeg")
...
img2=r"C:\project\digitalhealthcardsystemqrcode.png"
...
def d_reg_entry():
    ...
    try:        
        ...
        cursor.execute(operation,values)
        dbcon.commit()
        messagebox.showinfo("Digital Health Card System","Doctor registration has been successfully registered.")
